...
void EMC2301_setFanPoles(uint8_t poleCount)// Set the number of fan poles
{
  // uint8_t writeByte;
  switch (poleCount)
  {
  case 1:
    ...
    EMC2301_WriteRegconfig_Byte(EMC2301_FANCONFIG1, EMC2301_FANCONFIG1_FANPOLES_CLEAR, EMC2301_FANCONFIG1_FANPOLES_1);
    MULTIPLIER = 1;
    break;
  case 2:
    // writeByte = EMC2301_FANCONFIG1_FANPOLES_2;
    EMC2301_WriteRegconfig_Byte(EMC2301_FANCONFIG1, EMC2301_FANCONFIG1_FANPOLES_CLEAR, EMC2301_FANCONFIG1_FANPOLES_2);
    MULTIPLIER = 2;
    break;
  case 3:
    // writeByte = EMC2301_FANCONFIG1_FANPOLES_3;
    EMC2301_WriteRegconfig_Byte(EMC2301_FANCONFIG1, EMC2301_FANCONFIG1_FANPOLES_CLEAR, EMC2301_FANCONFIG1_FANPOLES_3);
    MULTIPLIER = 3;
    break;
  case 4:
    // writeByte = EMC2301_FANCONFIG1_FANPOLES_4;
    EMC2301_WriteRegconfig_Byte(EMC2301_FANCONFIG1, EMC2301_FANCONFIG1_FANPOLES_CLEAR, EMC2301_FANCONFIG1_FANPOLES_4);
    MULTIPLIER = 4;
  default:
    break;
  }
...
void EMC2301_setDerivativeMode(uint8_t modeType)// Change the derivative type used in the RPM based speed control PID algorithm
{
  switch (modeType)
  {
  case 0:
    EMC2301_WriteRegconfig_Byte(EMC2301_FANCONFIG2, EMC2301_FANCONFIG2_DEROPT_CLEAR, EMC2301_FANCONFIG2_DEROPT_NONE);
    break;
  case 1:
    EMC2301_WriteRegconfig_Byte(EMC2301_FANCONFIG2, EMC2301_FANCONFIG2_DEROPT_CLEAR, EMC2301_FANCONFIG2_DEROPT_BASIC);
    break;
  case 2:
    EMC2301_WriteRegconfig_Byte(EMC2301_FANCONFIG2, EMC2301_FANCONFIG2_DEROPT_CLEAR, EMC2301_FANCONFIG2_DEROPT_STEP);
    break;
  case 3:
    EMC2301_WriteRegconfig_Byte(EMC2301_FANCONFIG2, EMC2301_FANCONFIG2_DEROPT_CLEAR, EMC2301_FANCONFIG2_DEROPT_BOTH);
  default:
    break;
  }
}
